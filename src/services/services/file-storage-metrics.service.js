...
exports.FileStorageMetricsService = void 0;
var common_1 = require("@nestjs/common");
var client = require("prom-client");
var FileStorageMetricsService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var FileStorageMetricsService = _classThis = /** @class */ (function () {
        function FileStorageMetricsService_1() {
        ...
        FileStorageMetricsService_1.prototype.recordUpload = function (contentType, fileSize) {
            this.uploadCounter.inc({ content_type: contentType });
            this.fileSizeHistogram.observe(fileSize);
        };
        FileStorageMetricsService_1.prototype.recordDownload = function (contentType) {
            this.downloadCounter.inc({ content_type: contentType });
        };
        FileStorageMetricsService_1.prototype.recordDelete = function () {
            this.deleteCounter.inc();
        };
        FileStorageMetricsService_1.prototype.recordError = function (errorType) {
            this.errorCounter.inc({ error_type: errorType });
        };
        FileStorageMetricsService_1.prototype.getMetrics = function () {
        ...
        return FileStorageMetricsService_1;
    }());
    __setFunctionName(_classThis, "FileStorageMetricsService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        FileStorageMetricsService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FileStorageMetricsService = _classThis;
}();
exports.FileStorageMetricsService = FileStorageMetricsService;
